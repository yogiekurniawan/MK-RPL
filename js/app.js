angular.module('rpl', [
	...
	.value('Rs', 'https://uas-rpl-demo.firebaseio.com/rumah-sakit')

	.factory('Items', function($firebase, fbURL){
		return $firebase(new Firebase(fbURL));
	})

	.factory('rumahSakit', function($firebase, Rs){
		return $firebase(new Firebase(Rs));
	})
	...
	.controller('rplHomeCtrl', function($scope, Items, rumahSakit){ /* S:controller home.html */
		$scope.items = Items;
		$scope.rumahSakit = rumahSakit;
	...
	.controller('rplAddCtrl', function($scope, $location, $timeout, Items){ 
		$scope.save = function(){
			...
			//Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); });Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); });
			//Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); });Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); }); Items.$add($scope.item, function(){$timeout(function() { $location.path('/'); }); });
		};
	})
